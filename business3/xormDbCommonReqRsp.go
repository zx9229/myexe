...
//To omit
func (thls *DbCommonReqRsp) To() ProtoMessage {
...
//ToC2Req omit
func (thls *DbCommonReqRsp) ToC2Req() (dst *txdata.Common2Req) {
...
//ToC2Rsp omit
func (thls *DbCommonReqRsp) ToC2Rsp() (dst *txdata.Common2Rsp) {
